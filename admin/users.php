                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered">
                                ...
                                try{
                                    ...
                                    foreach($stmt as $row){
                                        ...
                                        $status = ($row['status']) ? '<span class="label label-success">فعال</span>' : '<span class="label label-danger">تایید نشده</span>';
                          ...
                          <tr>
                            ...
                            <td>
                              <a href='cart.php?user=".$row['id']."' class='btn btn-info btn-sm btn-flat'><i class='fa fa-search'></i> سبد خرید</a>
