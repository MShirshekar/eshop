            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="cart_add.php">
                ...
                <div class="form-group">
                    <label for="product" class="col-sm-3 control-label">محصول</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="cart_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_quantity" class="col-sm-3 control-label">تعداد</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>حذف سبد خرید</b></h4>
            </div>
            <div class="modal-body">
