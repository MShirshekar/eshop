    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>ایجاد حساب کاربری جدید</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">نشانی</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">اطلاعات تماس</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>ویرایش کاربر</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                <input type="hidden" class="userid" name="id">
                <div class="form-group">
                    <label for="edit_email" class="col-sm-3 control-label">ایمیل</label>
                ...
                <div class="form-group">
                    <label for="edit_password" class="col-sm-3 control-label">کلمه عبور</label>
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">نام خانوادگی</label>
                ...
                <div class="form-group">
                    <label for="edit_address" class="col-sm-3 control-label">نشانی</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">اطلاعات تماس</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> بستن</button>
              <button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> به روز رسانی</button>
              </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> بستن</button>
              <button type="submit" class="btn btn-success btn-flat" name="upload"><i class="fa fa-check-square-o"></i> به روز رسانی</button>
              </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>فعال‌سازی...</b></h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> بستن</button>
              <button type="submit" class="btn btn-success btn-flat" name="activate"><i class="fa fa-check"></i> فعال‌سازی</button>
              </form>
            </div>
        </div>
    </div>
