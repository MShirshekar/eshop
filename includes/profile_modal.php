    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>ویرایش حساب کاربری</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">شماره تماس</label>
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">تصویر پروفایل</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">رمز کنونی</label>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> ذخیره</button>
              </form>
            </div>
        </div>
    </div>
