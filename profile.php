	        	...
	        	<div class="col-sm-9">
	        						...
	        						<div class="col-sm-9">
	        							<h4><?php echo $user['firstname'].' '.$user['lastname']; ?>
	        								<span class="pull-right">
	        									<a href="#edit" class="btn btn-success btn-flat btn-sm" data-toggle="modal"><i class="fa fa-edit"></i> ویرایش</a>
	        								</span>
	        							</h4>
	        		...
	        		<div class="box box-solid">
	        			<div class="box-header with-border">
	        				<h4 class="box-title"><i class="fa fa-calendar"></i> <b>تاریخچه تراکنش‌ها</b></h4>
	        			</div>
	        			<div class="box-body">
	        							...
	        							foreach($stmt as $row){
	        								...
	        								echo "
	        									<tr>
	        										...
	        										<td><button class='btn btn-sm btn-flat btn-info transact' data-id='".$row['id']."'><i class='fa fa-search'></i> نمایش</button></td>
	        									</tr>
	        								";
	        							}
